...
const SolarSystemAnimation = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      // Gentle camera movement with adjusted zoom
      camera.position.x = Math.cos(time * 0.1) * 250;
      camera.position.z = Math.sin(time * 0.1) * 250;
      camera.position.y = 90 + Math.sin(time * 0.05) * 25;
      camera.lookAt(0, 0, 0);
