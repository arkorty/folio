...
const TAB_DATA = [
    ...
    content: (
      <ul className="list-disc pl-4">
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">Linux & Unix Systems</strong>{" "}
        ...
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">Build Systems & CI/CD</strong>{" "}
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-4">
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">Rust</strong> Intermediate
          knowledge with a focus on systems programming and memory-safe code.
        </li>
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">C++</strong> Intermediate
          experience in writing high-performance code and understanding of core
          concepts like OOP, STL, and memory management.
        </li>
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">JavaScript</strong> Have some
          experience building full-stack web apps.
        </li>
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">Go</strong> Beginner-level
  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-4">
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">AWS</strong> Have experience
          deploying nginx reverse proxies, containerized backends and Nextcloud
          instances using services like EC2 & S3.
        </li>
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">Oracle Cloud</strong> Beginner
          knowledge in using Compute Engine and Scalable Storage.
        </li>
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">Vercel</strong> Beginner
          experience deploying frontend applications with seamless integration
          of CI/CD for Next.js projects.
        </li>
        <li className="mb-4 text-gray-400">
          <strong className="text-white text-xl">GitHub</strong> Advanced use of
          GitHub features for collaborative development, automation via Actions,
  ...
  return (
    <section className="text-white" id="about">
      <div className="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16">
        <Image src="/about.jpg" width={512} height={512} alt="about.jpg" />
        <div className="mt-4 md:mt-0 text-left flex flex-col h-full">
          <h2 className="text-4xl font-bold text-white mb-4">About Me</h2>
          <p className="text-justify lg:text-lg">
            Hey! I&apos;m Arka, a programmer who loves open-source and tinkering
